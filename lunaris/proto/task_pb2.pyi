...
class Task(_message.Message):
    __slots__ = ("task_id", "code", "input", "lua_version", "priority", "version")
    ...
    priority: int
    version: int
    def __init__(self, task_id: _Optional[str] = ..., code: _Optional[str] = ..., input: _Optional[str] = ..., lua_version: _Optional[_Union[LuaVersion, str]] = ..., priority: _Optional[int] = ..., version: _Optional[int] = ...) -> None: ...

class TaskResult(_message.Message):
    __slots__ = ("task_id", "status", "result", "stdout", "stderr", "time", "version")
    TASK_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    time: float
    version: int
    def __init__(self, task_id: _Optional[str] = ..., status: _Optional[_Union[Status, str]] = ..., result: _Optional[str] = ..., stdout: _Optional[str] = ..., stderr: _Optional[str] = ..., time: _Optional[float] = ..., version: _Optional[int] = ...) -> None: ...
...
class NodeStatus(_message.Message):
    __slots__ = ("status", "max_concurrency", "available_mem", "processing_tasks")
    ...
    def __init__(self, status: _Optional[_Union[NodeStatus.NodeState, str]] = ..., max_concurrency: _Optional[int] = ..., available_mem: _Optional[int] = ..., processing_tasks: _Optional[_Iterable[str]] = ...) -> None: ...
